    ...
    def run_demo():
        ...
        for article in random_articles:
            ...
            --- QUERY ----
             ...
             Rewrite the query for clarity and return your response in the following JSON format:
            ...
            llm_response = llm.json_prompt_llm(rewrite_prompt,json_example=json_example)
            rewritten_query = llm_response[list(llm_response.keys())[0]]

            print ('\n ------ REWRITTEN QUERY ------ \n')
            print (rewritten_query)

            new_context = Retr.retrieve_context(text_splits,rewritten_query,Neural_Net())
